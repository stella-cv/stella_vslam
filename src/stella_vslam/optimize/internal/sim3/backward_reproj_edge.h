#ifndef STELLA_VSLAM_OPTIMIZE_G2O_BACKWARD_REPROJ_EDGE_H
#define STELLA_VSLAM_OPTIMIZE_G2O_BACKWARD_REPROJ_EDGE_H
...
#endif // STELLA_VSLAM_OPTIMIZE_G2O_BACKWARD_REPROJ_EDGE_H
