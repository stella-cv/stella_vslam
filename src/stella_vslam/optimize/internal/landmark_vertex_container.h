#ifndef STELLA_VSLAM_OPTIMIZE_G2O_LANDMARK_VERTEX_CONTAINER_H
#define STELLA_VSLAM_OPTIMIZE_G2O_LANDMARK_VERTEX_CONTAINER_H
...
#endif // STELLA_VSLAM_OPTIMIZE_G2O_LANDMARK_VERTEX_CONTAINER_H
