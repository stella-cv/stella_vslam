#ifndef STELLA_VSLAM_OPTIMIZE_G2O_SE3_SHOT_VERTEX_CONTAINER_H
#define STELLA_VSLAM_OPTIMIZE_G2O_SE3_SHOT_VERTEX_CONTAINER_H
...
#endif // STELLA_VSLAM_OPTIMIZE_G2O_SE3_SHOT_VERTEX_CONTAINER_H
