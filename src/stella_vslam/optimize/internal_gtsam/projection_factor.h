#ifndef STELLA_VSLAM_OPTIMIZE_INTERNAL_GTSAM_PROJECTION_FACTOR_H
#define STELLA_VSLAM_OPTIMIZE_INTERNAL_GTSAM_PROJECTION_FACTOR_H
...
public:
    ...
    gtsam::Vector evaluateError(const POSE& pose, const LANDMARK& point,
        ...
        try {
            ...
            SPDLOG_TRACE("{} : Landmarks is behind the camera", e.what());
        }
...
#endif // STELLA_VSLAM_OPTIMIZE_INTERNAL_GTSAM_PROJECTION_FACTOR_H
