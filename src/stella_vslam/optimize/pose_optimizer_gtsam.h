#ifndef STELLA_VSLAM_OPTIMIZE_POSE_OPTIMIZER_GTSAM_H
#define STELLA_VSLAM_OPTIMIZE_POSE_OPTIMIZER_GTSAM_H
...
#endif // STELLA_VSLAM_OPTIMIZE_POSE_OPTIMIZER_GTSAM_H
