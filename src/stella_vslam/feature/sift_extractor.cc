...
void sift_extractor::extract(const cv::_InputArray& in_image, const cv::_InputArray& in_image_mask,
    ...
    auto sift_detector = cv::SIFT::create(0, this->params_->num_sublevels_, this->params_->threshold_, this->params_->edge_threshold_, this->params_->scale_factor_, CV_32F);
